...
describe('Validation Error Handling Integration Tests', () => {
  ...
  describe('Boolean Field Validation', () => {
    it('should accept valid boolean string values', async () => {
      ...
      expect(wishlistServer.addToWishlist).toHaveBeenCalledWith('user-123', 'perfume-456', true)
    })
  ...
  describe('Request Method Validation', () => {
    it('should reject GET requests to POST endpoints', async () => {
      const request = new Request('https://example.com/api/wishlist?perfumeId=perfume-456&action=add', {
        method: 'GET'
      })
  ...
  describe('Successful Validation', () => {
    it('should accept valid request with all required fields', async () => {
      ...
      expect(wishlistServer.addToWishlist).toHaveBeenCalledWith('user-123', 'perfume-456', false)
    })
