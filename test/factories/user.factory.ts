 ...
 */
export function createMockUser(overrides: CreateMockUserOptions = {}): Omit<User, 'UserPerfume' | 'userPerfumeComments' | 'UserPerfumeRating' | 'UserPerfumeReview' | 'UserPerfumeWishlist' | 'wishlistNotifications' | 'userAlerts' | 'alertPreferences'> {
  // Handle explicit null values for optional fields
  const firstName = overrides.firstName !== undefined ? overrides.firstName : faker.person.firstName()
  const lastName = overrides.lastName !== undefined ? overrides.lastName : faker.person.lastName()
  const username = overrides.username !== undefined ? overrides.username : faker.internet.username({ firstName: firstName || undefined, lastName: lastName || undefined })

  return {
    id: overrides.id ?? faker.string.uuid(),
    email: overrides.email ?? faker.internet.email({ firstName: firstName || undefined, lastName: lastName || undefined }).toLowerCase(),
 ...
 */
export function createMockAdminUser(overrides: CreateMockUserOptions = {}): Omit<User, 'UserPerfume' | 'userPerfumeComments' | 'UserPerfumeRating' | 'UserPerfumeReview' | 'UserPerfumeWishlist' | 'wishlistNotifications' | 'userAlerts' | 'alertPreferences'> {
 ...
 */
export function createMockEditorUser(overrides: CreateMockUserOptions = {}): Omit<User, 'UserPerfume' | 'userPerfumeComments' | 'UserPerfumeRating' | 'UserPerfumeReview' | 'UserPerfumeWishlist' | 'wishlistNotifications' | 'userAlerts' | 'alertPreferences'> {
  return createMockUser({
    ...overrides,
    role: 'editor',
...
): Array<Omit<User, 'UserPerfume' | 'userPerfumeComments' | 'UserPerfumeRating' | 'UserPerfumeReview' | 'UserPerfumeWishlist' | 'wishlistNotifications' | 'userAlerts' | 'alertPreferences'>> {
