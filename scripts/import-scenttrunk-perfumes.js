#!/usr/bin/env node
/**
 * Import Scent Trunk Perfumes to database
...
async function createOrGetPerfumeHouse(houseName) {
  ...
  return await prisma.perfumeHouse.create({
    data: {
      ...
      type: "indie", // Scent Trunk is an indie house
    },
  })
}
...
async function importScentTrunkPerfumesData() {
  const csvFile = "perfumes_scenttrunk.csv"
