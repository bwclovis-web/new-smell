#!/usr/bin/env node
/**
 * Import Aaron Terence Hughes perfumes from CSV
...
async function importAaronTerenceHughesPerfumes() {
  console.log('🚀 Starting Aaron Terence Hughes import...\n')

  const csvPath = path.join(__dirname, '../csv/perfumes_aaronterencehughes.csv')
  ...
  // Create or get the Aaron Terence Hughes house
  const house = await createOrGetPerfumeHouse('Aaron Terence Hughes')
  console.log('')
...
importAaronTerenceHughesPerfumes()
  .then(async () => {
