// Import script for perfumes_the-moon-in-bloom.csv from csv directory
...
async function main() {
  console.log("🚀 Starting CSV import for The Moon in Bloom...")

  const csvFiles = ["perfumes_the-moon-in-bloom.csv"]
