// Import script for perfumes_imaginary-authors.csv from csv directory
...
async function main() {
  console.log("🚀 Starting CSV import for Imaginary Authors...")

  const csvFiles = ["perfumes_imaginary-authors.csv"]
