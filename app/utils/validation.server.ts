...
export function validatePerfumeId(perfumeId: string | null) {
  ...
  try {
    ...
    return createErrorResponse(error instanceof Error ? error.message : 'Invalid perfume ID', 400)
  }
}
...
export function validateActionType(actionType: string | null) {
  ...
  try {
    ...
    return createErrorResponse(error instanceof Error ? error.message : 'Invalid action type', 400)
  }
}
...
export function validateUserId(userId: string | null) {
  ...
  try {
    ...
    return createErrorResponse(error instanceof Error ? error.message : 'Invalid user ID', 400)
  }
}
...
export function validateCommentId(commentId: string | null) {
  ...
  try {
    ...
    return createErrorResponse(error instanceof Error ? error.message : 'Invalid comment ID', 400)
  }
}
...
export function validateRatingValue(rating: number | null) {
  ...
  try {
    ...
    return createErrorResponse(error instanceof Error ? error.message : 'Invalid rating value', 400)
  }
}
...
export function validateAmountValue(amount: string | null) {
  ...
  try {
    ...
    return createErrorResponse(error instanceof Error ? error.message : 'Invalid amount value', 400)
  }
}
...
export function validatePriceValue(price: string | null) {
  ...
  try {
    ...
    return createErrorResponse(error instanceof Error ? error.message : 'Invalid price value', 400)
  }
}
...
export const commonValidationSchemas = {
  id: z.string().min(1, { message: 'ID is required' }).regex(/^[a-zA-Z0-9-_]+$/, {
