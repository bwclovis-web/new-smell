...
export const dynamicComponentImports = {
  ...
  dataQualityDashboard: () => import('~/components/Containers/DataQualityDashboard/DataQualityDashboard'),
  ...
  // Heavy UI components
  virtualScrollDemo: () => import('~/components/Examples/VirtualScrollDemo/VirtualScrollDemo'),

  // Chart components (if using chart libraries)
  chartComponents: () => import('~/components/Containers/DataQualityDashboard/DataQualityDashboard'),
