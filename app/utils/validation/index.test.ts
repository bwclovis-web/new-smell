...
describe("validateAndTransform", () => {
  ...
  it("should handle transformation errors", () => {
    const result = validateAndTransform(schema, { name: "John", age: 30 }, () => {
...
describe("validateObject", () => {
  ...
  it("should validate object properties", () => {
    const result = validateObject({ name: "John", age: 30 }, validators)
  ...
  it("should throw for invalid properties", () => {
    expect(() => validateObject({ name: 123, age: 30 }, validators)).toThrow("name:")
  })
})
