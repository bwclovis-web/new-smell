...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-8 items-center justify-center min-h-screen px-4 relative bg-noir-gold-500/30" ref={container}>
      <img src={banner} alt="" className="hero-image absolute object-cover w-full h-1/2 lg:h-full filter grayscale-[100%] contrast-[1.4] brightness-[0.9] sepia-[0.2] mix-blend-multiply" />
