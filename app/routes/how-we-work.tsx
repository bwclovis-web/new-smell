      ...
      <section className="inner-container py-12">
        <article className="mx-auto">
          <div className="prose prose-lg prose-invert gap-10 flex flex-col">
            <section className="gap-6 flex flex-col md:flex-row border-b border-noir-gold pb-10 items-center">
              <OptimizedImage
                src={matchImage}
                alt=""
                width={840}
                height={840}
                className="w-full md:w-3/4 lg:w-2/3 max-w-4xl aspect-[5/4] rounded-xl bg-transparent border-8 border-noir-light shadow-lg shadow-black filter grayscale-[10%] contrast-[1] brightness-[0.9] sepia-[0.5] mix-blend-overlay"
            ...
            <section className="gap-6 flex flex-col md:flex-row-reverse border-b border-noir-gold pb-10 items-center">
              <OptimizedImage
                src={decant}
                alt=""
                width={1040}
            ...
            <section className="gap-6 flex flex-col md:flex-row border-b border-noir-gold pb-10 items-center">
              <OptimizedImage
                ...
                width={1040}
                height={840}
                className="w-full md:w-3/4 lg:w-2/3 max-w-4xl aspect-[5/4] rounded-xl bg-transparent border-8 border-noir-light shadow-lg shadow-black filter grayscale-[10%] contrast-[1] brightness-[1.1] sepia-[0.5] mix-blend-overlay"
                sizes="(min-width: 1440px) 55vw, (min-width: 1024px) 65vw, 90vw"
                objectFit="cover"
                placeholder="blur"
              />
            ...
            <OptimizedImage
                ...
                width={1040}
                height={840}
                className="w-full md:w-3/4 lg:w-2/3 max-w-4xl aspect-[5/4] rounded-xl bg-transparent border-8 border-noir-light shadow-lg shadow-black filter grayscale-[10%] contrast-[1] brightness-[0.9] sepia-[0.9] mix-blend-overlay"
                sizes="(min-width: 1440px) 55vw, (min-width: 1024px) 65vw, 90vw"
                objectFit="cover"
                placeholder="blur"
              />
