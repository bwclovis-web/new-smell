...
const TermsAndConditions = () => {
  ...
  return (
    <article>
      <TitleBanner imagePos="object-center" image={banner} heading={t('termsAndConditions.heading')} subheading={t('termsAndConditions.subheading')} />
      ...
      <section className="max-w-7xl mx-auto mt-8 bg-noir-dark p-8 rounded-lg border border-noir-gold">
        <h2 className="mb-4">2. {t('termsAndConditions.tradingAndListing.heading')}</h2>
        <div className="flex flex-col gap-4 text-noir-gold-100 text-lg">
      ...
      <section className="max-w-7xl mx-auto mt-8 bg-noir-dark p-8 rounded-lg border border-noir-gold">
        <h2 className="mb-4">3. {t('termsAndConditions.accountsAndConduct.heading')}</h2>
        <div className="flex flex-col gap-4 text-noir-gold-100 text-lg">
      ...
      <section className="max-w-7xl mx-auto mt-8 bg-noir-dark p-8 rounded-lg border border-noir-gold">
        <h2 className="mb-4">4. {t('termsAndConditions.reviewsAndNotes.heading')}</h2>
        <div className="flex flex-col gap-4 text-noir-gold-100 text-lg">
