        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 inner-container">
          {wishlist.map(item => {
            ...
            const availableAmount = item.perfume.userPerfume.reduce(
              (total, userPerfume) => total + parseFloat(userPerfume.available || "0"),
              0
            )
            return (
              <WishlistItemCard
