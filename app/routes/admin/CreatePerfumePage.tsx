...
import { type ActionFunctionArgs, type MetaFunction, redirect, useActionData } from 'react-router'
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'An error occurred while creating the perfume'
    }
  }
}
