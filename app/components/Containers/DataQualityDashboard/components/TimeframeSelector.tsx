...
const TimeframeSelector: FC<TimeframeSelectorProps> = ({ timeframe, setTimeframe }) => (
  <div className="mb-6">
    ...
    <div className="flex space-x-2">
      ...
      <button
        ...
        className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${timeframe === 'all'
            ? 'bg-blue-600 text-white'
            : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
          }`}
      >
