...
describe('VooDooCheck', () => {
  ...
  describe('Styling', () => {
    it('should apply unchecked styling', () => {
      ...
      expect(toggleButton).toHaveClass('bg-noir-gray', 'translate-x-0', 'border-noir-black')
    })
    ...
    it('should apply checked styling', () => {
      ...
      expect(toggleButton).toHaveClass('bg-noir-gold-500', 'translate-x-6', 'border-noir-gold-100')
    })
    ...
    it('should have proper label styling', () => {
      ...
      const label = screen.getByText('Off')
      expect(label).toHaveClass('text-sm', 'font-medium', 'text-noir-gold-100', 'ml-2')
    })
