...
describe('FormField', () => {
  describe('Rendering', () => {
    ...
    it('should render with help text', () => {
      ...
      expect(screen.getByText('This is help text')).toHaveAttribute('id', 'help-text')
    })
  })
  ...
  describe('Required field', () => {
    it('should show required indicator when required is true', () => {
      ...
      expect(label).toHaveClass('after:content-["*"]', 'after:ml-1', 'after:text-red-500')
    })
  ...
  describe('Validation states', () => {
    ...
    it('should apply info styling and attributes', () => {
      ...
      const input = screen.getByRole('textbox')
      expect(input).toHaveClass('border-blue-300', 'focus:border-blue-500', 'focus:ring-blue-500')
  ...
  describe('Validation icons', () => {
    ...
    it('should show warning icon when showValidationIcon is true and has warning', () => {
      ...
      const warningIcon = screen.getByRole('textbox').parentElement?.querySelector('svg')
    ...
    it('should show info icon when showValidationIcon is true and has info', () => {
      ...
      const infoIcon = screen.getByRole('textbox').parentElement?.querySelector('svg')
      expect(infoIcon).toBeInTheDocument()
      expect(infoIcon).toHaveClass('text-blue-500')
    })

    it('should not show validation icon when showValidationIcon is false', () => {
      render(<FormField label="Test Label" error="Error message" showValidationIcon={false}>
          <input type="text" />
        </FormField>)

      const iconContainer = screen.getByRole('textbox').parentElement?.querySelector('.absolute')
