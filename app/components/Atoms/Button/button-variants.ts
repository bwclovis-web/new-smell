...
export const buttonVariants = cva(
  ["rounded-sm cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed aria-disabled:opacity-50 aria-disabled:cursor-not-allowed",],
  {
    compoundVariants: [{}],
    defaultVariants: {
      size: "md",
    ...
    variants: {
      ...
      variant: {
        primary:
          "bg-noir-gold capitalize text-noir-black px-4 py-2 rounded-md font-semibold hover:bg-noir-gold/80 transition-all",
        secondary:
          "bg-noir-dark hover:bg-noir-black focus:bg-noir-black disabled:bg-noir-black text-noir-gold-500 hover:text-noir-gold-100 border border-noir-gold hover:border-noir-gold-500",
        danger:
