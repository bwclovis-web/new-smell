...
vi.mock('../FormField/FormField', () => ({
  default: ({ children, label, error, success, required, disabled, className, labelClassName, fieldClassName, helpText, showValidationIcon }: any) => (
    <div className={className}>
      ...
      <div className={fieldClassName}>
        ...
        {showValidationIcon && (error || success) && <div data-testid="validation-icon">icon</div>}
      </div>
    </div>
  )
}))
...
describe('ValidatedInput', () => {
  ...
  describe('Styling', () => {
    ...
    it('should pass custom labelClassName to FormField', () => {
      render(<ValidatedInput {...defaultProps} label="Test Label" labelClassName="custom-label" />)
