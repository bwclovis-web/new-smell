...
describe('ReviewCard', () => {
  ...
  describe('User Display Name', () => {
    ...
    it('creates avatar with correct first letter for each display name type', () => {
      const testCases = [
        ...
        { username: null, firstName: null, lastName: null, email: 'dan@example.com', expected: 'D' }
      ]
  ...
  describe('Date Formatting', () => {
    ...
    it('handles various date formats', () => {
      const testDates = [
        { date: new Date('2024-01-14T12:00:00Z').toISOString(), expected: '1 day ago' },
        { date: new Date('2024-01-15T12:00:00Z').toISOString(), expected: 'today' }
      ]
