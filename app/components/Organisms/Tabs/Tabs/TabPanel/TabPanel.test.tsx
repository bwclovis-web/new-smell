...
describe('TabPanel', () => {
  it('renders the content of the child TabItem', () => {
    render(
      <TabPanel idx={0} child={getTabItem('Tab 1', 'Panel Content')} activeTab={0} type="secondary" />
    )
  ...
  it('is hidden when not the active tab', () => {
    render(
      <TabPanel idx={1} child={getTabItem('Tab 2', 'Hidden Content')} activeTab={0} type="secondary" />
    )
  ...
  it('is visible when it is the active tab', () => {
    render(
      <TabPanel idx={2} child={getTabItem('Tab 3', 'Visible Content')} activeTab={2} type="secondary" />
    )
  ...
  it('sets correct aria-labelledby and id', () => {
    render(
      <TabPanel idx={3} child={getTabItem('Tab 4', 'Aria Content')} activeTab={3} type="secondary" />
    )
    const section = screen.getByRole('tabpanel')
