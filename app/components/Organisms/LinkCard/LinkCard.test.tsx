...
describe('LinkCard', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders image with correct src', () => {
      ...
      const image = screen.getByRole('img', { name: 'Test Perfume' })
    ...
    it('does not render house name when not provided', () => {
      ...
      renderWithRouter(
        <LinkCard data={dataWithoutHouse} type="perfume" />
      )
    ...
    it('does not render type badge when type is not provided', () => {
      ...
      renderWithRouter(
        <LinkCard data={dataWithoutType} type="perfume" />
      )
  ...
  describe('Navigation', () => {
    ...
    it('links to house page when type is house', () => {
      renderWithRouter(
        <LinkCard data={mockHouseData} type="house" />
      )
      const link = screen.getByRole('link')
  ...
  describe('Image Display', () => {
    ...
    it('applies grayscale filter class', () => {
      renderWithRouter(
        <LinkCard data={mockPerfumeData} type="perfume" />
      )
      const image = screen.getByRole('img')
    ...
    it('applies contain style for performance', () => {
      renderWithRouter(
        <LinkCard data={mockPerfumeData} type="perfume" />
      )
      const image = screen.getByRole('img') as HTMLImageElement
    ...
    it('renders different perfume types correctly', () => {
      ...
      types.forEach(type => {
        ...
        const { unmount } = renderWithRouter(
          <LinkCard data={data} type="perfume" />
        )
  ...
  describe('Text Wrapping', () => {
    ...
    it('handles long perfume names', () => {
      ...
      renderWithRouter(
        <LinkCard data={longNameData} type="perfume" />
      )
  ...
  describe('Edge Cases', () => {
    it('handles missing image gracefully', () => {
      ...
      expect(() => renderWithRouter(
        <LinkCard data={dataWithoutImage} type="perfume" />
      )).not.toThrow()
    })
    ...
    it('handles special characters in name', () => {
      ...
      renderWithRouter(
        <LinkCard data={specialCharData} type="perfume" />
      )
    ...
    it('handles empty perfumeHouse object', () => {
      ...
      renderWithRouter(
        <LinkCard data={dataWithEmptyHouse} type="perfume" />
      )
  ...
  describe('View Transition', () => {
    ...
    it('sets unique viewTransitionName based on item id', () => {
      renderWithRouter(
        <LinkCard data={mockPerfumeData} type="perfume" />
      )
      const image = screen.getByRole('img') as HTMLImageElement
    ...
    it('creates different viewTransitionName for different items', () => {
      const data1 = { ...mockPerfumeData, id: 'perfume-1' }
      const data2 = { ...mockPerfumeData, id: 'perfume-2', name: 'Another Perfume' }

      const { unmount } = renderWithRouter(
        <LinkCard data={data1} type="perfume" />
      )

      const image1 = screen.getByRole('img') as HTMLImageElement
      expect(image1.style.viewTransitionName).toBe('perfume-image-perfume-1')
      unmount()

      renderWithRouter(
        <LinkCard data={data2} type="perfume" />
      )

      const image2 = screen.getByRole('img') as HTMLImageElement
