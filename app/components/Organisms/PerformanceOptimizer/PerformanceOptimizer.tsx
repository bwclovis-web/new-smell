...
const PerformanceOptimizer: React.FC<PerformanceOptimizerProps> = ({
  ...
  const defaultRules: OptimizationRule[] = [
    ...
    },
    {
      ...
      description: 'Simplify complex DOM structures for better rendering performance',
      category: 'rendering',
      priority: 'medium',
      enabled: true,
      action: () => {
    ...
    <div className={styleMerge('bg-white border border-gray-200 rounded-lg shadow-lg p-6', className)}>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-2">
          <div className={`w-3 h-3 rounded-full ${isRunning ? 'bg-blue-400 animate-pulse' : 'bg-gray-400'}`} />
      ...
      {/* Optimization Rules */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-gray-700 mb-4">Optimization Rules</h3>
          ...
          {rules.map(rule => (
            <div key={rule.id} className="p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center space-x-2">
                  <span className={`text-xs px-2 py-1 rounded ${getImpactColor(rule.impact)}`}>
                    {rule.impact} impact
                  </span>
      ...
      {optimizations.length > 0 && (
        <div>
          <h3 className="text-lg font-semibold text-gray-700 mb-4">Optimization Results</h3>
          <div className="space-y-3">
